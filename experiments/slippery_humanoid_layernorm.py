...
from continual_learning.configs.optim import AdamwConfig
    ...
    for opt_name, opt_conf in optimizers.items():
        ...
        trainer = JittedContinualPPOTrainer(
            ...
            logs_cfg=LoggingConfig(
                run_name=f"{opt_name}_layernorm_humanoid_{args.seed}",
                wandb_entity=args.wandb_entity,
                wandb_project=args.wandb_project,
                group=f"slippery_humanoid_layernorm_{opt_name}",

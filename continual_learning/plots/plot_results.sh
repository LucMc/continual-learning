...
python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metrics gradient_norm --combine-networks --output-dir plots/main/combined/unnorm --ext png --plot-title "Gradient Norm"
...
python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metrics gradient_norm --combine-networks --output-dir plots/main/combined/unnorm/no_iqr --ext png --plot-title "Gradient Norm" --no-show-iqr
...
python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metrics gradient_norm --combine-networks --output-dir plots/main/combined --ext png --plot-title "Gradient Norm"
python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metrics srank_hidden --combine-networks --output-dir plots/main/combined --ext png --plot-title "S-rank"
...
python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metrics gradient_norm --combine-networks --output-dir plots/main/combined/no_iqr --ext png --plot-title "Gradient Norm" --no-show-iqr
python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metrics srank_hidden --combine-networks --output-dir plots/main/combined/no_iqr --ext png --plot-title "S-rank" --no-show-iqr
...
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics gradient_norm --combine-networks --output-dir plots/humanoid --ext png --plot-title "Gradient Norm Humanoid"
...
python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metric nn/vf_gradient_norm --output-dir plots/main --ext png --plot-title "Value Network Gradient Norm 2"
python backup2_analyze.py $WANDB_CFG --group slippery_ant_bigbatch --wandb_project crl_experiments --metric charts/mean_episodic_return --output-dir plots/bigbatch $WANDB_CFG --group ccbp_server --wandb_project crl_final --metric nn/policy_gradient_norm --output-dir plots/main --ext png --plot-title "Policy Network Gradient Norm 2"
...
python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metric nn/vf_gradient_norm --output-dir plots/main/no_iqr --ext png --plot-title "Value Network Gradient Norm 2" --no-show-iqr
python backup2_analyze.py $WANDB_CFG --group slippery_ant_bigbatch --wandb_project crl_experiments --metric charts/mean_episodic_return --output-dir plots/bigbatch/no_iqr $WANDB_CFG --group ccbp_server --wandb_project crl_final --metric nn/policy_gradient_norm --output-dir plots/main/no_iqr --ext png --plot-title "Policy Network Gradient Norm 2" --no-show-iqr

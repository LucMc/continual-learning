...
################################################################################
# Number of collapses
python plot_policy_collapse.py --wandb-entity lucmc --group cpr_server --wandb_project crl_final --metric charts/mean_episodic_return --collapse_threshold 8000 --output-dir plots/collapse_bar --overall --min-consecutive-below 10 --output-name cpr_server
# Percentage of runs collapsed
python plot_policy_collapse.py --wandb-entity lucmc --group cpr_server --wandb_project crl_final --metric charts/mean_episodic_return --collapse_threshold 8000 --output-dir plots/collapse_bar --overall --min-consecutive-below 10 --output-name cpr_server --percentage
#
# ################################################################################
...
################################################################################
# Slippery Ant Results (cpr_server group)
################################################################################
# With IQR
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric charts/mean_episodic_return --output-dir plots/main --ext png --bar-chart --y-min 0 --plot-title "Mean Episodic Return"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_dormant_neurons/total_ratio --output-dir plots/main --ext png --plot-title "cpr_server_value_dormant_neurons"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_dormant_neurons/total_ratio --output-dir plots/main --ext png --plot-title "cpr_server_actor_dormant_neurons"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_linearised_neurons/total_ratio --output-dir plots/main --ext png --plot-title "cpr_server_value_linearised_neurons"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_linearised_neurons/total_ratio --output-dir plots/main --ext png --plot-title "cpr_server_actor_linearised_neurons"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_parameter_norm --output-dir plots/main --ext png --plot-title "cpr_server_policy_parameter_norm"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/vf_parameter_norm --output-dir plots/main --ext png --plot-title "cpr_server_vf_parameter_norm"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/vf_gradient_norm --output-dir plots/main --ext png --plot-title "Value Network Gradient Norm"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_gradient_norm --output-dir plots/main --ext png --plot-title "Policy Network Gradient Norm"

# Without IQR
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric charts/mean_episodic_return --output-dir plots/main/no_iqr --ext png --bar-chart --y-min 0 --plot-title "Mean Episodic Return" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_dormant_neurons/total_ratio --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_value_dormant_neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_dormant_neurons/total_ratio --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_actor_dormant_neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_linearised_neurons/total_ratio --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_value_linearised_neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_linearised_neurons/total_ratio --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_actor_linearised_neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_parameter_norm --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_policy_parameter_norm" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/vf_parameter_norm --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_vf_parameter_norm" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/vf_gradient_norm --output-dir plots/main/no_iqr --ext png --plot-title "Value Network Gradient Norm" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_gradient_norm --output-dir plots/main/no_iqr --ext png --plot-title "Policy Network Gradient Norm" --no-show-iqr

################################################################################
# Combined network plots (cpr_server group)
################################################################################
# With IQR
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric dormant --combine-networks --output-dir plots/main/combined --ext png --plot-title "Dormant Neurons"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric linearized --combine-networks --output-dir plots/main/combined --ext png --plot-title "Linearized Neurons"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics gradient_norm --combine-networks --output-dir plots/main/combined --ext png --plot-title "CPR Gradient Norm"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics srank_hidden --combine-networks --output-dir plots/main/combined --ext png --plot-title "S-rank"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics parameter_norm --combine-networks --output-dir plots/main/combined --ext png --plot-title "Parameter Norm"

# Without IQR
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric dormant --combine-networks --output-dir plots/main/combined/no_iqr --ext png --plot-title "Dormant Neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric linearized --combine-networks --output-dir plots/main/combined/no_iqr --ext png --plot-title "Linearized Neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics gradient_norm --combine-networks --output-dir plots/main/combined/no_iqr --ext png --plot-title "CPR Gradient Norm" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics srank_hidden --combine-networks --output-dir plots/main/combined/no_iqr --ext png --plot-title "S-rank" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics parameter_norm --combine-networks --output-dir plots/main/combined/no_iqr --ext png --plot-title "Parameter Norm" --no-show-iqr

################################################################################
# S-rank metrics - Layer-wise (cpr_server group)
################################################################################
# With IQR
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_0_act --output-dir plots/main --ext png --plot-title "cpr_server_value_srank_layer_0"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/layer_0_act --output-dir plots/main --ext png --plot-title "cpr_server_actor_srank_layer_0"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_1_act --output-dir plots/main --ext png --plot-title "cpr_server_value_srank_layer_1"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/layer_1_act --output-dir plots/main --ext png --plot-title "cpr_server_actor_srank_layer_1"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_2_act --output-dir plots/main --ext png --plot-title "cpr_server_value_srank_layer_2"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/layer_2_act --output-dir plots/main --ext png --plot-title "cpr_server_actor_srank_layer_2"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_3_act --output-dir plots/main --ext png --plot-title "cpr_server_value_srank_layer_3"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/layer_3_act --output-dir plots/main --ext png --plot-title "cpr_server_actor_srank_layer_3"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/output_act --output-dir plots/main --ext png --plot-title "cpr_server_value_srank_output"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/output_act --output-dir plots/main --ext png --plot-title "cpr_server_actor_srank_output"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics value_srank_hidden --output-dir plots/main --ext png --plot-title "cpr_server_value_srank_hidden"
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics actor_srank_hidden --output-dir plots/main --ext png --plot-title "cpr_server_actor_srank_hidden"

# Without IQR
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_0_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_value_srank_layer_0" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/layer_0_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_actor_srank_layer_0" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_1_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_value_srank_layer_1" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/layer_1_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_actor_srank_layer_1" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_2_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_value_srank_layer_2" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/layer_2_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_actor_srank_layer_2" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_3_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_value_srank_layer_3" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/layer_3_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_actor_srank_layer_3" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/output_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_value_srank_output" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_srank/main/output_act --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_actor_srank_output" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics value_srank_hidden --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_value_srank_hidden" --no-show-iqr
python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics actor_srank_hidden --output-dir plots/main/no_iqr --ext png --plot-title "cpr_server_actor_srank_hidden" --no-show-iqr

################################################################################
# Slippery Humanoid - Individual network plots (without IQR)
################################################################################
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric charts/mean_episodic_return --output-dir plots/humanoid/no_iqr --ext png --bar-chart --y-min -2000 --plot-title "Mean Episodic Return" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric nn/value_dormant_neurons/total_ratio --output-dir plots/humanoid/no_iqr --ext png --plot-title "humanoid_value_dormant_neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric nn/actor_dormant_neurons/total_ratio --output-dir plots/humanoid/no_iqr --ext png --plot-title "humanoid_actor_dormant_neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric nn/value_linearised_neurons/total_ratio --output-dir plots/humanoid/no_iqr --ext png --plot-title "humanoid_value_linearised_neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric nn/actor_linearised_neurons/total_ratio --output-dir plots/humanoid/no_iqr --ext png --plot-title "humanoid_actor_linearised_neurons" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric nn/policy_parameter_norm --output-dir plots/humanoid/no_iqr --ext png --plot-title "humanoid_policy_parameter_norm" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric nn/vf_parameter_norm --output-dir plots/humanoid/no_iqr --ext png --plot-title "humanoid_vf_parameter_norm" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric nn/vf_gradient_norm --output-dir plots/humanoid/no_iqr --ext png --plot-title "Value Network Gradient Norm" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metric nn/policy_gradient_norm --output-dir plots/humanoid/no_iqr --ext png --plot-title "Policy Network Gradient Norm" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics value_srank_hidden --output-dir plots/humanoid/no_iqr --ext png --plot-title "humanoid_value_srank_hidden" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics actor_srank_hidden --output-dir plots/humanoid/no_iqr --ext png --plot-title "humanoid_actor_srank_hidden" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics dormant --combine-networks --output-dir plots/humanoid/no_iqr --ext png --plot-title "Dormant Neurons Humanoid" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics linearized --combine-networks --output-dir plots/humanoid/no_iqr --ext png --plot-title "Linearized Neurons Humanoid" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics gradient_norm --combine-networks --output-dir plots/humanoid/no_iqr --ext png --plot-title "Gradient Norm Humanoid" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics srank_hidden --combine-networks --output-dir plots/humanoid/no_iqr --ext png --plot-title "S-rank Humanoid" --no-show-iqr
python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics parameter_norm --combine-networks --output-dir plots/humanoid/no_iqr --ext png --plot-title "Parameter Norm Humanoid" --no-show-iqr

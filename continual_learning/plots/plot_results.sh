 ...
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric charts/mean_episodic_return --output-dir plots/main # Maybe make yaml files for each experiment or something?
 
 # Slippery Ant Rseults
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric charts/mean_episodic_return --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_dormant_neurons/total_ratio --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_dormant_neurons/total_ratio --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_linearised_neurons/total_ratio --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/actor_linearised_neurons/total_ratio --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_parameter_norm --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/vf_parameter_norm --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/vf_gradient_norm --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_gradient_norm --output-dir plots/main --ext png

 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_0_act --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_srank/layer_0_act --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_1_act --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_srank/layer_1_act --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_2_act --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_srank/layer_2_act --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/value_srank/layer_3_act --output-dir plots/main --ext png
 # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metric nn/policy_srank/layer_3_act --output-dir plots/main --ext png
 ...
 # python plot_policy_collapse.py --wandb-entity lucmc --group cpr_server --wandb_project crl_final --metric charts/mean_episodic_return --collapse_threshold 9000 --output-dir plots/collapse_bar
 ...
 # Ablations
     # CPR
     python ablation_plot.py --wandb-entity lucmc --wandb_project crl_experiments --group slippery_ant_cpr_sweep_backup --metric charts/mean_episodic_return --grouping-mode parameter --split-by transform_type --ext png --output-dir plots/ablations/cpr
     # python ablation_plot.py --wandb-entity lucmc --wandb_project crl_experiments --group slippery_ant_cpr_sweep --metric charts/mean_episodic_return --grouping-mode parameter --split-by replacement_rate --ext png --output-dir plots/ablations/cpr
     # python ablation_plot.py --wandb-entity lucmc --wandb_project crl_experiments --group slippery_ant_cpr_sweep --metric charts/mean_episodic_return --grouping-mode parameter --split-by decay_rate --ext png --output-dir plots/ablations/cpr
     # python ablation_plot.py --wandb-entity lucmc --wandb_project crl_experiments --group slippery_ant_cpr_sweep --metric charts/mean_episodic_return --grouping-mode parameter --split-by sharpness --ext png --output-dir plots/ablations/cpr
     # python ablation_plot.py --wandb-entity lucmc --wandb_project crl_experiments --group slippery_ant_cpr_sweep --metric charts/mean_episodic_return --grouping-mode parameter --split-by threshold --ext png --output-dir plots/ablations/cpr
     # python ablation_plot.py --wandb-entity lucmc --wandb_project crl_experiments --group slippery_ant_cpr_sweep --metric charts/mean_episodic_return --grouping-mode parameter --split-by update_frequency --ext png --output-dir plots/ablations/cpr
     ...
     # Combined
     # python analyze.py $WANDB_CFG --group cpr_server --wandb_project crl_final --metrics dormant,linearized --combine-networks --output-dir plots/main --ext png

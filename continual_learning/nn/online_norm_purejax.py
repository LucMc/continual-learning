# -*- coding: utf-8 -*-
"""
This is a JAX implementation of the Online Normalization algorithm and the 
components which go into it. This was inspired by the official numpy implementation: 
https://github.com/Cerebras/online-normalization/blob/master/online-norm/numpy_on/online_norm_1d.py
"""
import warnings
...
def norm_forward(inputs, mstream, varstream, afwd, eps):
    ...
    """
    # Function to process a single sample and update stats

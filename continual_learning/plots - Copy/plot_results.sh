...
#
 ...
 # python analyze.py $WANDB_CFG --group slippery_ant_bigbatch --wandb_project crl_experiments --metric charts/mean_episodic_return --output-dir plots/bigbatch --no-show-iqr
 # python analyze.py $WANDB_CFG  --group slippery_ant_bigbatch --wandb_project crl_experiments --metric dormant --combine-networks --output-dir plots/bigbatch/combined --ext png  --plot-title "Dormant Neurons" --no-show-iqr
 # python analyze.py $WANDB_CFG  --group slippery_ant_bigbatch --wandb_project crl_experiments --metric linearized --combine-networks --output-dir plots/bigbatch/combined --ext png  --plot-title "Linearized Neurons" --no-show-iqr
 ...
 # python analyze.py $WANDB_CFG  --group slippery_ant_bigbatch --wandb_project crl_experiments --metrics gradient_norm --combine-networks --output-dir plots/bigbatch/combined --ext png --plot-title "Gradient Norm" --no-show-iqr
 ...
 # Ablations
     ...
     # python ablation_plot.py --wandb-entity lucmc --wandb_project crl_experiments --group ccbp_replacement_rate --metric charts/mean_episodic_return --grouping-mode parameter --split-by replacement_rate --ext png --output-dir plots/ablations/ccbp --plot-title "Stability-Plastiticy Tuning" --no-show-iqr
 ...
 # python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics srank_hidden --combine-networks --output-dir plots/humanoid --ext png --normalize-networks --plot-title "Humanoid S-rank" --no-show-iqr
 # python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics dormant --combine-networks --output-dir plots/humanoid --ext png --normalize-networks --plot-title "Humanoid dormant Neurons" --no-show-iqr
 # python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics linearized --combine-networks --output-dir plots/humanoid --ext png --normalize-networks --plot-title "Humanoid Linearized Neurons" --no-show-iqr
 # python analyze.py $WANDB_CFG --group slippery_humanoid_full6 --wandb_project crl_humanoid --metrics gradient_norm --combine-networks --output-dir plots/humanoid --ext png --normalize-networks --plot-title "Humanoid Gradient Norm" --no-show-iqr

...
from continual_learning_2.trainers.continual_rl import JittedContinualPPOTrainer, GymPPOTrainer
...
def muon_gym_invertedpendulum_experiment() -> None:
    args = tyro.cli(Args)
...
if __name__ == "__main__":
    muon_gym_invertedpendulum_experiment()
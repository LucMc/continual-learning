 # python analyze.py $WANDB_CFG --group slippery_ant_full --metric charts/mean_episodic_return # Maybe make yaml files for each experiment or something?
 # python analyze.py $WANDB_CFG --group ccbp_server --wandb_project crl_final --metric charts/mean_episodic_return # Maybe make yaml files for each experiment or something?
 ...
 # python plot_policy_collapse.py --wandb-entity lucmc --group ccbp_server --wandb_project crl_final --metric charts/mean_episodic_return --collapse_threshold 9000
